...
To deal with such categorical data, we have a special class `factor` in R.  In data analytical tasks we often need to create use factors, so let us discuss about these in a bit detail.
