...
divide our customisation requirements of these scales into three
categories, which we learn in this section.

-   position scales,
-   color (or fill) scales
-   other scales.

### Position scales i.e. transforming axes
...
In figure \@ref(fig:scale4), we have modified (i) name of `x` axis, (ii) breaks, which places the label, (iii) label for 2 digits of year, (iv) limited the data to be plotted, (v) name of `y` axis and (vi) modified the bales of `y` axis as percentages; all using scale functions.
